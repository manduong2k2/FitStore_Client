...
function Home() {
  ...
  axios
    .get("http://jul2nd.ddns.net/recommend/topSolds", {
  ...
  axios
    .get("http://jul2nd.ddns.net/recommend/topRating", {
      headers: { authorization: getCookie("token") },
    })
    .then((response) => {
  ...
  axios
    .get("http://jul2nd.ddns.net/recommend", {
      headers: { authorization: getCookie("token") },
    })
    .then((response) => {
      if (response.data) {
    ...
    .catch((err) => console.log(err));
  axios
    .get("http://jul2nd.ddns.net/recommend/watched", {
      headers: { authorization: getCookie("token") },
    })
    .then((response) => {
      if (response.data) {
...
function PersonalAccountEdit() {
  ...
  var root = document.getElementById("root");
  axios
    .get("http://jul2nd.ddns.net/account/" + getCookie("id"))
    .then((response) => {
